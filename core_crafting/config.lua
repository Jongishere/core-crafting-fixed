...
['handcuffs'] = {
	ItemName = 'Handcuffs',
	Level = 4, -- From what level this item will be craftable
	Category = 'Goods', -- The category item will be put in
	isGun = false, -- Specify if this is a gun so it will be added to the loadout
	Jobs = {}, -- What jobs can craft this item, leaving {} allows any job
	JobGrades = {}, -- What job grades can craft this item, leaving {} allows any grade
	Amount = 1, -- The amount that will be crafted
...
Workbenches = { -- Every workbench location, leave {} for jobs if you want everybody to access
		...
		{coords = vector3(-1080.33, -1671.41, 4.7), jobs = {}, Categories = 'GunCategories', blip = false, recipes = {}, radius = 3.0 }, --Gun crafting 1 
		{coords = vector3(-809.2475,190.274,72.81208), jobs = {}, Categories = 'ItemsCategories', blip = false, recipes = {}, radius = 3.0} --Gun crafting 2 
...
Text = {
    ...
    ['workbench_hologram'] = '[~o~E~w~] Workbench',
